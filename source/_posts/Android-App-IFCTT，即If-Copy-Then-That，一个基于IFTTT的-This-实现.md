---
title: '[Android App]IFCTT，即If Copy Then That，一个基于IFTTT的`This`实现'
...
<img src="http://images2017.cnblogs.com/blog/378300/201712/378300-20171220203034178-1164844500.png" width=700px/>

选择设备为`Other (Custom name)`：

<img src="http://images2017.cnblogs.com/blog/378300/201712/378300-20171220203043037-400690546.png" width=700px/>

然后在输入框中填入`IFCTT`：

<img src="http://images2017.cnblogs.com/blog/378300/201712/378300-20171220203226818-331833630.png" width=700px/>

然后，点击`GENERATE`：

<img src="http://images2017.cnblogs.com/blog/378300/201712/378300-20171220203245959-1955556937.png" width=700px/>
...
<img src="http://images2017.cnblogs.com/blog/378300/201712/378300-20171220203309225-420821781.png" width=400px/>
...
<img src='http://images2017.cnblogs.com/blog/378300/201712/378300-20171220203418990-1206897620.png' width=350/>

下面以开启`instapaper`这个Hash tag为例

首先点击进入`#instapaper`的编辑页面，如下图：

<img src='http://images2017.cnblogs.com/blog/378300/201712/378300-20171220203437943-660274322.png' width=350/>

首先如上图中，先点击开启按钮

然后因为默认的Hash tag所对应的`IFTTT Applet`都已经创建好了，所以可以直接进入IFTTT的Applet界面添加并开启，如上图，点击红色字体部分或者`IFTTT`的图标，将会打开如下`IFTTT`的Applet界面：

<img src='http://images2017.cnblogs.com/blog/378300/201712/378300-20171220203505850-1035469032.png' width=350/>
...
<img src="http://images2017.cnblogs.com/blog/378300/201712/378300-20171220203609021-2048296548.png" width=350/>

点击首页右上角的`+`按钮，添加一个Hash tag，

<img src="http://images2017.cnblogs.com/blog/378300/201712/378300-20171220203626943-817117031.png" width=350/>
...
<img src="http://images2017.cnblogs.com/blog/378300/201712/378300-20171220203641803-289568452.png" width=350/>

`this`（trigger）选择`Email`，并选择**`Send IFTTT an email tagged`**（必须）：

<img src="http://images2017.cnblogs.com/blog/378300/201712/378300-20171220203700709-1346264994.png" width=350/>

上图中的`Tag`输入为`twitter`（[必须要与IFCTT中的一致](#tag_twitter)！），

`that`（action）选择`Twitter`，并选择**`Post a tweet`**，然后设置如下：

<img src="http://images2017.cnblogs.com/blog/378300/201712/378300-20171220203719959-403008307.png" width=350/>
